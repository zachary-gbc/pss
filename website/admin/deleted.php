...
if(isset($_POST['submit']))
{
    ...
    if(isset($_POST["recover$x"]))
    {
        ...
        $update="UPDATE pss_Graphics SET Gr_Name='$name', Gr_Delete='N' WHERE (Gr_ID='$id')";
    ...
    if(isset($_POST["delete$x"]))
    {
        ...
        $delete="DELETE FROM pss_Graphics WHERE (Gr_ID='$id')";
        if(!mysqli_query($db,$delete)) { echo("Unable to Run Query: $delete"); exit; }
    }
    }
}

    $graphics="SELECT * FROM pss_Graphics WHERE Gr_Delete='Y'"; $table=""; $x=0;
