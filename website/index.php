...
while($row = mysqli_fetch_array($rs))
{
    ...
    {
    $loopname="SELECT Lop_Name FROM pss_Loops WHERE (Lop_ID='" . substr($loop,2) . "')";
    ...
    {
    $graphicname="SELECT Gr_Name FROM pss_Graphics WHERE (Gr_ID='" . substr($loop,2) . "')";
...
$allloops="SELECT * FROM pss_Loops ORDER BY Lop_Name";
